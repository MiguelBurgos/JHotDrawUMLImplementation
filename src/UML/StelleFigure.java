...
public class StelleFigure extends GraphicalCompositeFigure {
    ...
    /**
     * Grafische Repr�sentation der Stelle
     */
    ...
    /**
     * TextFigure f�r die Festlegung des namens der Stelle (editierbar)
     */
    private TextFigure stelleNameFigure;
    
    /**
     * NumberTextFigure f�r die Aktuelle Anzahl der Marken
     */
    private NumberTextFigure aktAnzFigure;
    
    /**
     * NumberTextFigure f�r die minimale Anzahl der Marken
     */
    private NumberTextFigure minAnzFigure;
    
    /**
     * NumberTextFigure f�r die maximale Anzahl der Marken
     */
    private NumberTextFigure maxAnzFigure;
    
    /**
     * EllipseFigure f�r die Stelle
     */
    ...
    protected void initialize() {
        ...
        //***Stelle***
        // erzeuge a EllipseFigure f�r die darstellung der Stelle
       ...
       // stelleFigure.addDependendFigure
        ...
        stelleEllipseFigure.getLayouter().setInsets(new Insets(90, 90, 90, 90));//a.b.c.d (a h�he vertikal der ellipse) (b verschiebung nach rechts) (c Abstand nach unten) (d breite horizontal der ellipse)
        stelleEllipseFigure.moveBy(300, 300);
        
        
        
        //***Aktuelle Anzahl***
        // create a NumberTextFigure f�r die aktuelle Anzahl Marken
...
*/        
        ...
        // create a NumberTextFigure f�r die minimale Anzahl Marken
        ...
        // create a NumberTextFigure f�r die maximale Anzahl Marken
